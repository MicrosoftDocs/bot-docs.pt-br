...
- [Implantar QnA Maker base de dados de conhecimento usando os comandos da CLI do bot Framework qnamaker](#deploy-qna-maker-knowledge-base-using-the-bot-framework-qnamaker-cli-commands)
