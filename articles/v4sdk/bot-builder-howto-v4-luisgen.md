...
Use a [ferramenta LUISGen](https://aka.ms/botbuilder-tools-luisgen) para gerar classes que facilitam a extração de entidades do LUIS no código do bot.
