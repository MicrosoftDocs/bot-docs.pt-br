...
- Conhecimento sobre [noções básicas de bots][concept-basics], [gerenciamento de estado][concept-state], a [biblioteca de caixas de diálogo][concept-dialogs], e como [reutilizar caixas de diálogo][component-dialogs].
