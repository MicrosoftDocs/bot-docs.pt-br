...
O Webchat mais recente dá suporte ao uso de avatares, e você pode personalizá-los usando as propriedades `botAvatarInitials` e `userAvatarInitials`.
...
Dentro do código `renderWebChat`, adicionamos `botAvatarInitials` e `userAvatarInitials`:
