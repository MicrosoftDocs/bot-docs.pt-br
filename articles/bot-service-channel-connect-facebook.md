...
Os adaptadores do Facebook estão disponíveis para bots do [JavaScript/Node.js](https://aka.ms/botframework-workplace-adapter) e [C#/.NET](https://aka.ms/bf-workplace-csharp).
