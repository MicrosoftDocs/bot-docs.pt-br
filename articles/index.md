...
<div class="content">
    ...
    <div class="intro" style="min-width: 200px">
        <p>O Serviço de Bot fornece um ambiente integrado criado especificamente para desenvolver bots, permitindo criar, conectar, testar, implantar e gerenciar bots inteligentes em um único lugar. O serviço de bot aproveita o SDK do Construtor de Bot com suporte para .NET e Node.js. Saiba como usar o Serviço de Bot com nossos guias de início rápido, tutoriais e exemplos.</p>
    </div>
...
<p>Desenvolva bots usando o Serviço de Bot do Azure:</p>
<ol>
    <li><a href="/bot-framework/bot-builder-tutorial-authentication">Adicionar autenticação ao seu bot </a></li>
</ol>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/Bot-Framework/rest-api/bot-framework-rest-connector-api-reference">referência da API REST (a página pode estar em inglês)</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="content">
    <h1>Documentação do Serviço de Bot do Azure</h1>
    <div class="intro" style="min-width: 200px">
        <p><b> [Este tópico é uma documentação de pré-lançamento e está sujeita a alterações.] </b></p>
        <p>O Serviço de Bot do Azure fornece um ambiente integrado criado especificamente para desenvolver bots, permitindo criar, conectar, testar, implantar e gerenciar bots inteligentes em um único lugar. O Serviço de Bot do Azure aproveita o SDK do Construtor de Bot com suporte para C#, JavaScript, Python e Java. Saiba como usar o Serviço de Bot com nossos guias de início rápido, tutoriais e exemplos.
</p>
</div>
...
<p>Desenvolva bots usando o Serviço de Bot do Azure:</p>
<ol>
    <li><a href="/bot-framework/bot-builder-tutorial-waterfall">Faça perguntas ao usuário</a></li>
    <li><a href="/bot-framework/bot-builder-tutorial-persist-user-inputs">Manter os dados de usuário de uma conversa</a></li>
    <li><a href="/bot-framework/bot-builder-howto-translation">Torne seu bot multilíngue</a></li>
    <li><a href="/bot-framework/bot-builder-tutorial-dispatch">Integrar vários aplicativos LUIS e serviços do QnA com a ferramenta de Expedição</a></li>
</ol>
